...
#exemple pour lancer api_query : http://localhost:5010/api_query?query=SELECT book_title, rate, image_url_l FROM book INNER JOIN rating ON book.book_id = rating.book_id ORDER BY rate DESC LIMIT 10
